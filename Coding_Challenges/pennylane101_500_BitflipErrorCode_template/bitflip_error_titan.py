...
def error_wire(circuit_output):
    ...
    probs = np.zeros(4)
    probs[0] = circuit_output[0] + circuit_output[7]
    probs[1] = circuit_output[3] + circuit_output[4]
    probs[2] = circuit_output[2] + circuit_output[5]
    probs[3] = circuit_output[1] + circuit_output[6]
    return probs
    # QHACK #
